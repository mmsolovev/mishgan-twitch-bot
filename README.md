...
- `!игры <название>` или `!игра <название>`: статистика по игре и ссылка на общую таблицу;
- `!стримы <дата>` или `!стрим <дата>`: информация о стриме за дату и ссылка на общую таблицу;
